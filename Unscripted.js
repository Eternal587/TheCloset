...
if (choice === "2") {
  win.document.write('<body style="background-color: rgb(35, 35, 135, 1)"></body> <button onclick="newUnexTab()">Create Injected UNEX Tab</button> <script>function newUnexTab() { let x = prompt("Insert Code"); let y = window.open("google.com"); y.document.write(x); }</script>')
}
if (choice === "3") {
